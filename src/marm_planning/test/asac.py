...
if __name__ == '__main__':
    ...
    asac(lambda: gym.make(args.env), actor_critic=core.mlp_actor_critic, polyak=args.polyak,
         ac_kwargs=dict(hidden_sizes=[args.hid] * args.l),
         gamma=args.gamma, seed=args.seed, epochs=args.epochs,
         logger_kwargs=logger_kwargs, alpha_start=args.alpha_start,
         delta=args.delta, sample_step=args.sample_step, loss_threshold=args.loss_threshold,
         lr=args.lr)
