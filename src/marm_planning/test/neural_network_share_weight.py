...
class NeuralNetworks:
    ...
    # ================ Shared Functions ================ #
    def weight_variable(self, shape, value=0.1, rand='normal'):
        if rand == 'normal':
    ...
    def bias_variable(self, shape, value=0.1):
    ...
    def _create_actors(self, feature):
        ...
        """
        w1 = self.weight_variable([self._S_FEATURE_DIM, self._ACTOR_H1_DIM], value=0.2, rand='normal')
        b1 = self.bias_variable([self._ACTOR_H1_DIM])
        h1 = tf.nn.relu(tf.matmul(feature, w1) + b1)
        w2 = self.weight_variable([self._ACTOR_H1_DIM, self._A_DIM], value=0.2, rand='normal')
    ...
    def _create_critics(self, s_feature, action):
        ...
        b1 = self.bias_variable([self._CRITIC_H1_DIM], )
